...
class Mobile_suit{
  ...
  //TODO: **** may move all database utilization here ****
  ...
  add_MobileSuit(){ // may this function be the prototype for the rebuild.
    ...
    VALUES('${this.id}', '${this.model}', ${this.lvl},${this.hp},${this.defense},
           ${this.strength},${this.speed},${this.manned})`;
           
    var learderboard = `INSERT IGNORE INTO Leaderboard
                        (ID, Wins, Losses, MostUsed, HighestLvL, HighestDmg, CurrSuit)
                        VALUES('${this.id}', 0, 0,'--', 1, 0, '${this.model}'`
    ...
    try{
      con.query(exiting,(err,results)=>{
        if (err)console.log(err);
          ...
          // TODO: **** add query code for leaderboard ****
        }
      });
  ...
  //////////////////////////////////////////////////
  // Under lying query operations and object      //
  // Parsing for creating turn-based combat       //
  // scenarios. Function found in the hierarchy of//
  // the `combat` command.                        //
  //////////////////////////////////////////////////
